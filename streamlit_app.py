...
KEYWORDS = [
    "gestao de processos", "gestão de processos", "bpm",
    "mapeamento de processos", "modelagem de processos",
    "planejamento estratégico", "marketing", "pesquisa de mercado", "análise de dados"
]
...
if st.button("🔍 Buscar editais agora"):
    ...
    if todos_resultados:
        ...
        st.warning("⚠️ Nenhum edital relevante encontrado com base na classificação por IA.")

# Rodapé
st.caption("💡 Desenvolvido por sua IA consultora com ChatGPT-4.0 Mini.")
